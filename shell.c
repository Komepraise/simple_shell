 ...
 * @argc: numb of values received from the command line
 * @argv: values received from the command line
 * @env: numb of values received from the command line
...
void sisifo(char *prompt, program_data *data)
{
	...
	{
		_print(prompt);
		error_code = string_len = gt_line(data);
